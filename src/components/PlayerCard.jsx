...
function PlayerCard({onClick, player, countdown, mirrored, isTurn}) {
    return (
        <div onClick={onClick} className={"p-6 md:p-10 min-w-full sm:max-w-[650px] sm:min-w-[350px] flex-1 bg-gray-900 rounded-3xl flex flex-col items-center justify-center gap-6 select-none transition-[outline] outline outline-white" + (isTurn ? " outline-4" : " outline-0")}>
            ...
            <div className={"flex w-full"}>
                <div className={"p-2 aspect-square rounded-md shadow-md flex items-center justify-center transition-colors text-2xl " 
